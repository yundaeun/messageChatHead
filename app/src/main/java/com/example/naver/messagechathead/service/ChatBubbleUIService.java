...
import com.example.naver.messagechathead.chatBubble.ChatBubbleOpen;
...
public class ChatBubbleUIService extends Service {
	...
	public void onCreate() {
		...
		// open chat bubble
		ChatBubbleMore
			openChatBubbleMore = new ChatBubbleMore(getApplicationContext(), windowManager, chatBubbleDeleteBtn, chatRoomCreator, chatRoomListCreator);
		openChatBubbleMore.init();
		chatBubbleContainer.addChatBubbleOpen(openChatBubbleMore);

		ChatBubbleFace
			openChatBubbleFace = new ChatBubbleFace(getApplicationContext(), windowManager, chatBubbleDeleteBtn, chatRoomCreator, chatRoomListCreator);
